...
<!-- Vacío a propósito: TK-102 sigue sin implementar en `main`. Se completa en vivo durante la jornada de capacitación, siguiendo el plan de `proposal.md`/`design.md`/`tasks.md`. -->
