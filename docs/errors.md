...
> Base de conocimiento de errores comunes, síntomas, causa raíz y soluciones probadas.
...
- **Causa raíz**: bug conocido y sin arreglar en `main` — ver `tickets/TK-102/`. No es un problema de entorno, es el bug a resolver en el ejercicio.
- **Solución**: resolverlo como ticket (research → plan → fix + test). La solución de referencia vive en la rama `reference/tk-102`.
